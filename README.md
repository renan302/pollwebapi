...
- Acesse a pasta do projeto "PollWebApi" e execute o comando "dotnet ef database update", para iniciar um novo banco de dados;

- Na pasta raiz do projeto "PollWebApi", execute o comando "dotnet test", para executar os testes de integração;
